...
/**
   ...
   @brief This example will attempt to connect to an ISO14443B card and read card UID
   @version 0.1
   @date 2021-10-14
...
void loop(void) {
  ...
  success = nfc.readPassiveTargetID(PN532_MIFARE_ISO14443B, &uid[0], &uidLength);
