...
/**
   ...
   @brief  This example will wait for any NTAG203 or NTAG213 card or tag,and will attempt to erase the user data section of the card (setting all user bytes to 0x00)
   @version 0.1
   @date 2021-10-14
